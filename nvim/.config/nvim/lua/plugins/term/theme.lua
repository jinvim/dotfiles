return {
  -- themes
  {
    ...
    config = function()
      ...
      vim.cmd.highlight("TelescopeNormal", "guibg=" .. colors.bg0[1])
      vim.cmd.highlight("TelescopePromptNormal", "guibg=" .. colors.bg1[1])
      vim.cmd.highlight("TelescopeResultsNormal", "guibg=" .. colors.bg0[1])
      vim.cmd.highlight("TelescopePreviewNormal", "guibg=" .. colors.bg0[1])
      vim.cmd.highlight("TelescopeBorder", "guibg=" .. colors.bg0[1])
      vim.cmd.highlight("TelescopePromptBorder", "guibg=" .. colors.bg1[1])
      vim.cmd.highlight("TelescopeResultsBorder", "guibg=" .. colors.bg0[1])
      vim.cmd.highlight("TelescopePreviewBorder", "guibg=" .. colors.bg0[1])
      vim.cmd.highlight("TelescopePromptTitle", "guifg=" .. colors.bg0[1], "guibg=" .. colors.red[1])
      vim.cmd.highlight("TelescopeResultsTitle", "guifg=" .. colors.bg0[1], "guibg=" .. colors.blue[1])
      vim.cmd.highlight("TelescopePreviewTitle", "guifg=" .. colors.bg0[1], "guibg=" .. colors.aqua[1])
